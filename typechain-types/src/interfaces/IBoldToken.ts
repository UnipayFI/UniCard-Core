...
export interface IBoldTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DOMAIN_SEPARATOR"
      | "allowance"
...
export interface IBoldToken extends BaseContract {
  connect(runner?: ContractRunner | null): IBoldToken;
  waitForDeployment(): Promise<this>;

  interface: IBoldTokenInterface;
  ...
  returnFromPool: TypedContractMethod<
    [poolAddress: AddressLike, user: AddressLike, _amount: BigNumberish],
    [void],
    "nonpayable"
  >;

  sendToPool: TypedContractMethod<
    [_sender: AddressLike, poolAddress: AddressLike, _amount: BigNumberish],
    [void],
    "nonpayable"
  >;
