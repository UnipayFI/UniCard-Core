...
export interface IActivePoolInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface IActivePool extends BaseContract {
  connect(runner?: ContractRunner | null): IActivePool;
  ...
  mintAggInterestAndAccountForTroveChange: TypedContractMethod<
    [_troveChange: TroveChangeStruct, _batchManager: AddressLike],
    [void],
    "nonpayable"
  >;
