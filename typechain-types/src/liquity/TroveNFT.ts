...
export interface TroveNFTInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface TroveNFT extends BaseContract {
  connect(runner?: ContractRunner | null): TroveNFT;
  waitForDeployment(): Promise<this>;

  interface: TroveNFTInterface;
