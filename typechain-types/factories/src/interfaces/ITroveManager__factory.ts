...
} from "../../../src/interfaces/ITroveManager";
...
export class ITroveManager__factory {
  ...
  static createInterface(): ITroveManagerInterface {
    return new Interface(_abi) as ITroveManagerInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): ITroveManager {
    return new Contract(address, _abi, runner) as unknown as ITroveManager;
  }
}
